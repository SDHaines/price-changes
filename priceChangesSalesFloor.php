 ...
 * item and new price for items that reside on 
 * the sales floor. It's runs from cron on Friday 
...
WHERE  (I.ADDL_DESCR_1 NOT LIKE '% 50[mM][lL]%' OR I.ADDL_DESCR_1 NOT LIKE '% 375[mM][lL]%')
